...
st.markdown(
    "I search **arXiv** for papers. If they aren't relevant, I'll autonomously switch to **Web Search** to find your answer."
)
            ...
            for output in app.stream(inputs):
                for key, value in output.items():
                    if key == "classify_intent":
                        ...
                        if value.get("retrieved_context"):
                            st.session_state.retrieved_context = value["retrieved_context"]
                    elif key == "web_search":
